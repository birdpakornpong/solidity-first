...
contract BFLYVN is ERC20, AccessControl {
    ...
    constructor() ERC20("BFLYS", "Polygon") {
        _broker = 0xebdFB9D035e2C00Db964ceb4A208AF3CFB0F73dF;
        ...
        _setupRole(BROKER_ROLE, _broker); // WALLET COMPANY BROKER
        ...
        returns (bool success)
    {
        ...
        if (hasRole(NORMAL_ROLE, msg.sender)) {
            amount = (value * 9) / 10;
            amountBurn = (value * 5) / 100;
            _transfer(msg.sender, _broker, amountBurn);
        }
    ...
    function transferFrom(
        ...
        if (hasRole(NORMAL_ROLE, msg.sender)) {
            amount = (value * 9) / 10;
            amountBurn = (value * 5) / 100;
            _transfer(from, _broker, amountBurn);
        }
